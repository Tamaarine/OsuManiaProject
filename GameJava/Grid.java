...
public class Grid extends JComponent implements KeyListener, MouseListener
{
    ...
    private void init(int numRows, int numCols)
    {
        ...
        if(randomindex==0)
        {
            logobg=new ImageIcon(Grid.class.getResource("/Image Source/logo.png"));
        }
        else if(randomindex==1)
        {
            logobg=new ImageIcon(Grid.class.getResource("/Image Source/logo2.png"));
        }
        else if(randomindex==2)
        {
            logobg=new ImageIcon(Grid.class.getResource("/Image Source/logo3.png"));
        }
        else if(randomindex==3)
        {
            logobg=new ImageIcon(Grid.class.getResource("/Image Source/logo4.png"));
        }
        else
        {
            logobg=new ImageIcon(Grid.class.getResource("/Image Source/logo5.png"));
        }
        logo=new JLabel(logobg);
        
        this.add(logo);
        logo.setVisible(true);
        
        logo.setBounds(300,210,400,200);
        
        //frame.setLayout(null);
        
        frame.getContentPane().setPreferredSize(new Dimension(700,700));
        setBackground("/Image Source/background.jpg");
    ...
    {   
      ...
      //This area will be responsible of making the accuracy area
      g.setFont(new Font("Franklin Gothic",Font.PLAIN,50));
      
      g.setColor(new java.awt.Color(132,214,130));
      g.drawString("Accuracy:",300,50);
      
      g.setColor(new java.awt.Color(208,84,255));
      g.drawString(""+accuracy+"%",520,50);
      
      g.setFont(new Font("Franklin Gothic",Font.PLAIN,40));
      
      g.setColor(new java.awt.Color(125,186,132));
      g.drawString("Score:",300,110);
      
      g.setColor(new java.awt.Color(60,56,102));
      g.drawString(""+score,420,110);
      
      g.setColor(new java.awt.Color(119,173,120));
      g.drawString("Combo:",300,150);
      
      g.setColor(new java.awt.Color(134,229,232));
      g.drawString(combo+"X",440,150);
      
      g.setFont(new Font("Franklin Gothic",Font.BOLD,40));
      g.setColor(new java.awt.Color(96,33,20));
      g.drawString("Health",300,500);
      g.drawString("Bar",330,550);
      
      g.setColor(new java.awt.Color(255,105,54));
      //g.fillRect(440,400,100,health*2);
      g.fillRect(440,700-health*2,100,health*2);
      
      g.setColor(java.awt.Color.black);
      g.drawRect(440,700-health*2,100,health*2);
    ...
    public void setCombo(int givencombo)
    {
        combo=givencombo;
    }
    ...
    public void setAccuracy(int givennote,int givenhits)
    {
        double doubleaccuracy=((double)givenhits/givennote)*100;
        DecimalFormat df=new DecimalFormat("##.00");
        
        String rounddown=df.format(doubleaccuracy);
        
        try
        {
            accuracy=(Double)df.parse(rounddown);
        }
        catch(Exception e)
        {
            System.out.println("Error is only initally");
        }
    }
